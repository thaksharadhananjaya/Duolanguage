...
import 'package:duolanguage/screens/vocabulary/vocabulary.dart';
...
class Category extends StatelessWidget {
  ...
  const Category({Key? key, required this.language}) : super(key: key);
          ...
          children: [
            ...
            FutureBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    return buildCategoryList(snapshot, context);
                  }
                  return const Center(
                      child: SizedBox(
                          width: 100,
  ...
  SizedBox buildCategoryList(AsyncSnapshot snapshot, BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return buildCard(
                index, data['category'], data['link'], data.id, context);
          }),
    );
  }

  InkWell buildCard(
      int index, String text, String link, String docID, BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
